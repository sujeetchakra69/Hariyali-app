...
class AddSubcategory extends StatefulWidget {
  const AddSubcategory({super.key, required this.onCategoryAdded}); // Add a callback
...
class _AddSubcategoryState extends State<AddSubcategory> {
  ...
  final List<String> _categoryItems = [
    'Hariyali Seeds	','Hariyali Live Stock','Vehicle','Hariyali Fertilizer'
  ...
  void _save() {
    ...
    if (_selectedValue1 != null && categoryName.isNotEmpty &&_selectedValue2 != null ) {

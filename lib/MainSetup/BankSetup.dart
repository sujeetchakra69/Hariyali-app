...
import 'package:hariyali_abhiyan/Subcomponents/AddBank.dart';
          ...
          children: [
            Row( 
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>Addbank(onCategoryAdded: (newCategory){
                      setState(() {
                  ...
                  child: const Text('Add Bank',style: TextStyle(color: Colors.white, fontSize: 15.0),),

...
import 'package:hariyali_abhiyan/setup_subcomponent/addprojectmanager.dart';

class Businessmanager extends StatefulWidget {
  const Businessmanager({super.key});

  @override
  State<Businessmanager> createState() => _BusinessmanagerState();
}
          ...
          children: [
            Row( 
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>Addprojectmanager(onCategoryAdded: (newCategory){
                      setState(() {
                  ...
                  child: const Text('Create Manager',style: TextStyle(color: Colors.white, fontSize: 13.0),),
                  ...
                  rows: categories.asMap().entries.map<DataRow>((entry) {
                      ...
                      return DataRow(
                        cells: <DataCell>[
                          ...
                          // Category
                          DataCell(Text('${category['managername']}')), 
                          DataCell(Text('${category['projectname']}')), 
                          DataCell(Text('${category['number']}')), 

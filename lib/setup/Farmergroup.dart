...
import 'package:hariyali_abhiyan/setup_subcomponent/addfarmergroup.dart';

class Farmergroup extends StatefulWidget {
  const Farmergroup({super.key});

  @override
  State<Farmergroup> createState() => _FarmergroupState();
}
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => Addfarmergroup(
                  ...
                  rows: categories.asMap().entries.map<DataRow>((entry) {
                    ...
                    return DataRow(
                      cells: <DataCell>[
                        ...
                        // Category
                        DataCell(Text('${category['groupname']}')),

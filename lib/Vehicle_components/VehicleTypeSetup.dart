...
import 'package:hariyali_abhiyan/vehicle_sub_component/Addvehicletype.dart';

class VehicleTypeSetup extends StatefulWidget {
  const VehicleTypeSetup({super.key});

  @override
  State<VehicleTypeSetup> createState() => _VehicleTypeSetupState();
}

class _VehicleTypeSetupState extends State<VehicleTypeSetup> {
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => Addvehicletype(

...
import 'package:hariyali_abhiyan/vehicle_sub_component/addvehicle.dart';
          ...
          children: [
            Row( 
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>CreateVehiclePage(onCategoryAdded: (newCategories){
                      setState(() {
                  ...
                  child: const Text('Add Vehicle',style: TextStyle(color: Colors.white, fontSize: 13.0),),
                  ...
                  rows: categories.asMap().entries.map<DataRow>((entry) {
                      ...
                      return DataRow(
                        cells: <DataCell>[
                          ...
                          DataCell(Text('${category['Regno']}')), 
                          DataCell(Text('${category['Modelno']}')), 
                          DataCell(Text('${category['vehicleno']}')), // Name
